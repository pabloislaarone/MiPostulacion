...
fun etapaFormViewModelFactory(
    ...
    viewModelFactory {
        initializer {
            EtapaFormViewModel(app.container.postulacionRepository, postulacionId, etapaId)
        }
    }
...
fun authViewModelFactory(app: MiPostulacionApp): ViewModelProvider.Factory =
    viewModelFactory {
        initializer {
            AuthViewModel(app.container.authRepository, app.container.postulacionRepository)
        }
    }